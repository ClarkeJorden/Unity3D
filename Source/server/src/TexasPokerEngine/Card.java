...
public class Card implements Comparable<Card> {
	...
	public static final String[] RANK_COMPLETED_SYMBOLS = {
...
//			throw new IllegalArgumentException("Invalid rank");
			...
			rank = (rank < 0) ? 0 : (rank > NO_OF_RANKS - 1 ? NO_OF_RANKS - 1 : rank);
		}
		if (suit < 0 || suit > NO_OF_SUITS - 1) {
//			throw new IllegalArgumentException("Invalid suit");
			System.out.println("Invalid suit: " + suit);
			suit = (suit < 0) ? 0 : (suit > NO_OF_SUITS - 1 ? NO_OF_SUITS - 1 : suit);
		}
		this.rank = rank;
		this.suit = suit;
	}
